...
# =============================================================================
# State Machine for Commission Workflow
# =============================================================================
gem "aasm"                      # State machine for commission status tracking

# =============================================================================
# SEO & Marketing
# =============================================================================
gem "meta-tags"                 # SEO meta tags management
...
gem "friendly_id"               # SEO-friendly URLs (slugs)
...
gem "newrelic_rpm"              # New Relic APM for performance monitoring
...
group :test do
  ...
  gem "shoulda-matchers"              # One-liner tests for common Rails patterns
